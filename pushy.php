...
function save_post_hook_tomgp( $post_ID, $post, $update ) {
	...
	file_put_contents('save_post_hook_tomgp.json', $json);
  }
...
function trash_post_hook_tomgp( $post_id ) {
	...
	file_put_contents('trash_post_hook_tomgp.json', $json);
}
...
function untrash_post_hook_tomgp( $post_id ) {
    $json = wp_json_encode( $post_id);
	file_put_contents('untrash_post_hook_tomgp.json', $json);
}
...
function delete_post_hook_tomgp( $pid ) {
	...
	file_put_contents('delete_post_hook_tomgp.json', $json);
}
...
function update_category_function_tomgp($category_id) {
	...
	file_put_contents('update_category_function_tomgp.json', $json);
}
...
function update_nav_menu_function_tomgp($menu_id) {
	...
	file_put_contents('update_nav_menu_function_tomgp.json', $json);
}
...
function delete_nav_menu_function_tomgp($menu_id) {
	...
	file_put_contents('delete_nav_menu_function_tomgp.json', $json);
}
